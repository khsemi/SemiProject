...
%>            
            ...
            <tr>
               <td colspan="2">
               <input type="submit" class="btn btn-primary pull-right" value="일정작성"/>
               <input type="button" class="btn btn-primary pull-right" value="돌아가기" onclick="location.href='controller.do?category=CALENDAR'"/>
               </td>
            </tr>
      </table>
	</form>
