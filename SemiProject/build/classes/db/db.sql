...
-- 덤프 게시물 작성을 위한 관리자 계정 생성
INSERT INTO KH_USER 
VALUES(KH_USER_SEQ.NEXTVAL, 'admin', 'admin', '관리자', '관리자', '인천시', 'admin@admin.com', 'FALSE', 'TRUE', '01012345678', 'TRUE', 'ADMIN');

BEGIN
    FOR i IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, '공지사항 게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'NOTICE', NULL);
    END LOOP;
    FOR q IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, '자유게시판 게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'COMMUNITY', NULL);
    END LOOP;
    FOR w IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, '중고장터 게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'TRADE', NULL);
    END LOOP;
    FOR e IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, '취업정보게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'JOBS', NULL);
    END LOOP;
    FOR r IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, 'QA 게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'QA', NULL);
    END LOOP;
    FOR t IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, '고수팁 게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'TIPS', NULL);
    END LOOP;
    FOR y IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, '식당정보 게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'FOODINFO', NULL);
    END LOOP;
    FOR u IN 1..100 LOOP
        INSERT INTO KH_BOARD(BOARD_SEQ_ID, BOARD_TITLE, BOARD_CONTENT, BOARD_REGDATE, VIEW_COUNT, USER_SEQ, BOARD_CATEGORY, MAPS_ID) 
        VALUES(KH_BOARD_SEQ.NEXTVAL, '스터디그룹 게시글 테스트','이것은 테스트 내용입니다. 모두 테스트 하세요.', SYSDATE, 0, 1, 'STUDY', NULL);
    END LOOP;
END;
